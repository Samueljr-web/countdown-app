...
function HomePage({ setRespData }) {
  ...
  const baseURL =
    process.env.REACT_APP_API_URL || "http://localhost:3700/api/v1/";
      ...
      <div className="flex items-center min-h-screen md:space-x-5 space-y-2 justify-center md:flex-row flex-col">
        <div className="lg:w-[410px] md:w-[390px] w-[270px] h-[20rem]">
          <img
            src={ClockBg}
            alt="bg"
            className="md:w-[401px] w-full md:h-[15rem] h-[10rem] block mx-auto"
          />
          <h2 className="lg:text-[2rem] md:text-[1.5rem] text-[1.2rem] font-bold md:leading-[39px] leading-8">
            Create countdowns for your events fast, easy and quick
          </h2>
        </div>
        <div className="flex flex-col justify-center rounded-[8px] h-[21rem] p-5 bg-[#D2D4D3] shadow-md ">
          <form
            ...
            className="flex flex-col space-y-2 lg:w-[400px] md:w-[18rem] w-[15rem]"
          >
            ...
            <button
              type="submit"
              id="submit-btn"
              className="bg text-white  p-2 w-full rounded-[7px] outline-none"
            >
              Create countdown
            </button>
          </form>
